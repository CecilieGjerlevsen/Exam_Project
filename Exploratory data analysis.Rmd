...
freq_table_long %>% 
  ...
  scale_x_discrete(labels = c("Gender","Provided e-mail", "Provided work tel.no.","Owns a car","Provided tel.no.",
                              "Living city not working city", "Cash (1) or revolving loan (0)", "Accompanied when applying",
                              "Reg city not live city", "Reg city not work city", "Live city not work city")) + 
  labs(x = "", y = "Percentage", fill = "Binary features",title = "Binary feature variables") +
  theme_half_open(12) + 
