...
unique(application_data2$CODE_GENDER) #view the distinct values
...
#Removing columns with NA values over a limit.
```{r}
...
application_data2 <- application_data[, which(colMeans(is.na(application_data)) < 0.4)] #creating a new dataset where the 45 columns are deleted. 
