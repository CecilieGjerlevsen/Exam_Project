...
```{r}
#Business entities
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Business Entity Type 1"] <- "Business Entity"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Business Entity Type 2"] <- "Business Entity"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Business Entity Type 3"] <- "Business Entity"

#Industry
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 1"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 2"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 3"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 4"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 5"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 6"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 7"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 8"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 9"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 10"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 11"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 12"] <- "Industry"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Industry: type 13"] <- "Industry"

#Trade
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 1"] <- "Trade"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 2"] <- "Trade"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 3"] <- "Trade"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 4"] <- "Trade"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 5"] <- "Trade"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 6"] <- "Trade"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Trade: type 7"] <- "Trade"

#Transport
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Transport: type 1"] <- "Transport"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Transport: type 2"] <- "Transport"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Transport: type 3"] <- "Transport"
master_data$ORGANIZATION_TYPE[master_data$ORGANIZATION_TYPE == "Transport: type 4"] <- "Transport"
```

We disgard the variable called REGION_RATING_CLIENT as it is highly correlated with REGION_RATING_CLIENT_W_CITY
```{r}
imputed_data <- imputed_data[,!(names(imputed_data) %in% c("REGION_RATING_CLIENT"))]
```
