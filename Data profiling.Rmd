...
```{r}
master_data$NAME_TYPE_SUITE[master_data$NAME_TYPE_SUITE == "Children"] <- "Accompanied"
master_data$NAME_TYPE_SUITE[master_data$NAME_TYPE_SUITE == "Family"] <- "Accompanied"
master_data$NAME_TYPE_SUITE[master_data$NAME_TYPE_SUITE == "Group of people"] <- "Accompanied"
master_data$NAME_TYPE_SUITE[master_data$NAME_TYPE_SUITE == "Other_A"] <- "Accompanied"
master_data$NAME_TYPE_SUITE[master_data$NAME_TYPE_SUITE == "Other_B"] <- "Accompanied"
master_data$NAME_TYPE_SUITE[master_data$NAME_TYPE_SUITE == "Spouse, partner"] <- "Accompanied"
```
