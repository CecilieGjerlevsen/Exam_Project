...
```{r}
length(which(imputed_data$YEARS_EMPLOYED > 100))
#There are 55374 instances of this outcome.



#imputed_data$YEARS_EMPLOYED <- replace(imputed_data$YEARS_EMPLOYED,imputed_data$YEARS_EMPLOYED > 1000, mean(imputed_data$YEARS_EMPLOYED))

#imputed_data$YEARS_EMPLOYED <- replace(imputed_data$YEARS_EMPLOYED,imputed_data$YEARS_EMPLOYED > 100, mean(imputed_data$YEARS_EMPLOYED))
```
